    ...
    public void transform(ClassNode node, boolean dev) {
        for (MethodNode methodNode : node.methods) {
            ...
            if (renderLeftArm || renderRightArm) {
                ...
                insnList.add(new MethodInsnNode(INVOKESTATIC, "net/ilexiconn/llibrary/server/asm/transformer/RenderPlayerTransformer", "renderArm", "(Lnet/minecraft/client/renderer/entity/RenderPlayer;Lnet/minecraft/client/entity/AbstractClientPlayer;Lnet/ilexiconn/llibrary/server/util/EnumHandSide;)V", false));
