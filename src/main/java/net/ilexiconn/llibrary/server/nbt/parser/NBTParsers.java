...
public enum NBTParsers implements INBTParser {
    ...
    CHAR {
        @Override
        public Object parseTag(NBTBase tag) {
            return (char) ((NBTTagShort) tag).func_150289_e();
        }
    ...
    CHAR_ARRAY {
        ...
        public Object parseTag(NBTBase tag) {
            ...
            for (int i = 0; i < charArray.length; i++) {
                charArray[i] = (char) ((NBTTagShort) charList.tagList.get(i)).func_150289_e();
            }
            return charArray;
        }
    ...
    SHORT_ARRAY {
        ...
        public Object parseTag(NBTBase tag) {
            ...
            for (int i = 0; i < charArray.length; i++) {
                charArray[i] = ((NBTTagShort) charList.tagList.get(i)).func_150289_e();
            }
            return charArray;
        }
    ...
    FLOAT_ARRAY {
        ...
        public Object parseTag(NBTBase tag) {
            ...
            for (int i = 0; i < floatArray.length; i++) {
                floatArray[i] = ((NBTTagFloat) floatList.tagList.get(i)).func_150288_h();
            }
            return floatArray;
        }
    ...
    LONG_ARRAY {
        ...
        public Object parseTag(NBTBase tag) {
            ...
            for (int i = 0; i < longArray.length; i++) {
                longArray[i] = ((NBTTagLong) longList.tagList.get(i)).func_150291_c();
            }
            return longArray;
        }
    ...
    DOUBLE_ARRAY {
        ...
        public Object parseTag(NBTBase tag) {
            ...
            for (int i = 0; i < doubleArray.length; i++) {
                doubleArray[i] = ((NBTTagDouble) doubleList.tagList.get(i)).func_150286_g();
            }
            return doubleArray;
        }
    ...
    STRING_ARRAY {
        ...
        public Object parseTag(NBTBase tag) {
            ...
            for (int i = 0; i < stringArray.length; i++) {
                stringArray[i] = ((NBTTagString) stringList.tagList.get(i)).func_150285_a_();
            }
            return stringArray;
        }
